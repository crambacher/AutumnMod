...
public class RaccoonEntity extends TameableEntity implements IAnimatable {
    ...
    public boolean isBreedingItem(ItemStack stack) {
        return stack.getItem() == ModItems.LEAF;
    }
    ...
    protected void initGoals(){
        ...
        this.goalSelector.add(2, new EscapeDangerGoal(this, 1F));
        this.goalSelector.add(3, new AnimalMateGoal(this, 1F));
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = ModItems.ACORN;
