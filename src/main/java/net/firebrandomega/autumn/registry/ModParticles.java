...
public class ModParticles {
    ...
    public static final DefaultParticleType ALL_LEAF_PARTICLE = FabricParticleTypes.simple();
    ...
    public static void registerParticles(){
        ...
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(AutumnMod.MOD_ID,"all_leaf_particle"), ALL_LEAF_PARTICLE);
    }
}
