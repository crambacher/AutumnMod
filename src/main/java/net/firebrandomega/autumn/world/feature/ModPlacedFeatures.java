...
public class ModPlacedFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> MOD_AUTUMN_BIRCH_AND_OAK = PlacedFeatures.register(
            "autumn_birch_and_oak", VegetationConfiguredFeatures.TREES_BIRCH_AND_OAK, modifiers(
                    PlacedFeatures.createCountExtraModifier(3, 0.1F, 1)));

    public static final RegistryEntry<PlacedFeature> LEAF_PILE = PlacedFeatures.register(
            "leaf_pile",ModConfiguredFeatures.LEAF_PILE, CountPlacementModifier.of(2),
